...
const SFX_URLS = {
  ...
  // Laganija pozadinska muzika (chill sports vibe)
  bg: 'https://assets.mixkit.co/music/preview/mixkit-chill-bro-454.mp3' 
};
...
class AudioService {
  ...
  constructor() {
    if (typeof window !== 'undefined') {
      ...
      this.bgMusic.volume = 0.05; // Postavljeno na veoma lagano (5%)
    }
  }
